...
export const technicalSkillGroups: TechnicalSkillGroup[] = [
  {
    ...
    skills: [
      { name: "Next.js", tone: "indigo", icon: <Triangle className="h-5 w-5" /> },
      { name: "React.js", tone: "sky", icon: <Atom className="h-5 w-5" /> },
      { name: "MERN Stack", tone: "emerald", icon: <SquareStack className="h-5 w-5" /> },
      { name: "Tailwind CSS", tone: "violet", icon: <Palette className="h-5 w-5" /> },
  ...
  },
  {
    ...
    skills: [
      { name: "TypeScript", tone: "indigo", icon: <FileCode className="h-5 w-5" /> },
      { name: "JavaScript", tone: "amber", icon: <FileJson className="h-5 w-5" /> },
      { name: "C++", tone: "slate", icon: <Zap className="h-5 w-5" /> },
      { name: "Java", tone: "rose", icon: <Coffee className="h-5 w-5" /> },
      { name: "Python", tone: "emerald", icon: <Braces className="h-5 w-5" /> },
      { name: "C", tone: "sky", icon: <SquareCode className="h-5 w-5" /> },
    ],
    spotlight:
  ...
  },
  {
    ...
    skills: [
      { name: "Appwrite", tone: "rose", icon: <Flame className="h-5 w-5" /> },
